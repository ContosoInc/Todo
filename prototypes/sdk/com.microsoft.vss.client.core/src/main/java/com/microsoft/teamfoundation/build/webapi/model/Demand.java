...
import com.microsoft.vss.client.core.json.serialization.BuildDemandDeserializer;
import com.microsoft.vss.client.core.json.serialization.BuildDemandSerializer;
import com.microsoft.vss.client.core.utils.ArgumentUtility;
import com.microsoft.vss.client.core.utils.StringUtil;

@JsonDeserialize(using = BuildDemandDeserializer.class)
@JsonSerialize(using = BuildDemandSerializer.class)
