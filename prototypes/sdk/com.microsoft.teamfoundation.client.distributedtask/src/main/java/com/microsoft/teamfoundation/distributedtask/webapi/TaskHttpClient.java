...
public class TaskHttpClient
    ...
    public List<TimelineRecord> updateRecords(
            ...
            final UUID planId,
            final UUID timelineId) {
        return updateRecords(scopeIdentifier, hubName, VssJsonCollectionWrapper.newInstance(records), planId, timelineId);
    }
    ...
    public List<TimelineRecord> updateRecords(
        ...
        final Map<String, Object> routeValues = new HashMap<String, Object>();
        routeValues.put("scopeIdentifier", scopeIdentifier); //$NON-NLS-1$
        routeValues.put("hubName", hubName); //$NON-NLS-1$ //$NON-NLS-2$
        routeValues.put("planId", planId); //$NON-NLS-1$
        routeValues.put("timelineId", timelineId); //$NON-NLS-1$
    ...
    public Timeline getTimeline(
        ...
        return getTimeline(scopeIdentifier, hubName, planId, timelineId, (Integer) null, (Boolean) includeRecords);
    }
    ...
    public Timeline getTimeline(
            ...
            final UUID timelineId,
            final int changeId) {
        return getTimeline(scopeIdentifier, hubName, planId, timelineId, (Integer) changeId, (Boolean) null);
    }
